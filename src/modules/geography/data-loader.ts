...
export class GeographyDataLoader {
  ...
  private *generateCounties(): Generator<County> {
    const countyData: Array<[string, string, string, string, number, number]> = [
      // Counties for exact 16 locations (15 cities + Mountain View)
      ['36061', '36', 'New York County', 'NY', 1694202, 23], // New York NY
      ['06075', '06', 'San Francisco County', 'CA', 873965, 47], // San Francisco CA
      ['06085', '06', 'Santa Clara County', 'CA', 1927614, 1291], // Palo Alto CA
      ['06085', '06', 'Santa Clara County', 'CA', 1927614, 1291], // Menlo Park CA
      ['25025', '25', 'Suffolk County', 'MA', 684379, 48], // Boston MA
      ['17031', '17', 'Cook County', 'IL', 2746388, 234], // Chicago IL
      ['06037', '06', 'Los Angeles County', 'CA', 10001040, 4060], // Los Angeles CA
      ['48453', '48', 'Travis County', 'TX', 974447, 297], // Austin TX
      ['53033', '53', 'King County', 'WA', 2299646, 2126], // Seattle WA
      ['12086', '12', 'Miami-Dade County', 'FL', 2704160, 1946], // Miami FL
      ['11001', '11', 'District of Columbia', 'DC', 689545, 61], // Washington DC
      ['48113', '48', 'Dallas County', 'TX', 2635516, 879], // Dallas TX
      ['13121', '13', 'Fulton County', 'GA', 498715, 134], // Atlanta GA
      ['09001', '09', 'Fairfield County', 'CT', 62976, 48], // Greenwich CT
      ['06085', '06', 'Santa Clara County', 'CA', 1927614, 1291], // Mountain View CA
      ['06085', '06', 'Santa Clara County', 'CA', 1927614, 1291], // San Jose CA
    ];
  ...
  // EXACT 15-CITY LIST IN SPECIFIED ORDER
  ...
  // EXACT ZIP CODES ONLY - No generation, incrementing, or interpolation
  private *generateZipCodes(): Generator<ZipCode> {
    const zipData: Array<[string, string, string, string, number, number, number, number]> = [
      // New York NY: 10022 (Midtown), 10010 (Flatiron), 10004 (Financial District), 10017 (Park Avenue)
      ['10022', 'New York', 'NY', '36061', 40.7587, -73.9670, 39000, 0.4],
      ['10010', 'New York', 'NY', '36061', 40.7426, -73.9909, 38000, 0.3],
      ['10004', 'New York', 'NY', '36061', 40.7024, -74.0119, 32000, 0.5],
      ['10017', 'New York', 'NY', '36061', 40.7552, -73.9734, 41000, 0.4],
      
      // San Francisco CA: 94104 (Financial District), 94105 (SoMa)
      ['94104', 'San Francisco', 'CA', '06075', 37.7949, -122.3930, 28000, 0.6],
      ['94105', 'San Francisco', 'CA', '06075', 37.7905, -122.3920, 26000, 0.5],
      
      // Palo Alto / Menlo Park CA: 94301 (Palo Alto), 94025 (Sand Hill Road / Menlo Park)
      ['94301', 'Palo Alto', 'CA', '06085', 37.4419, -122.1430, 16000, 0.2],
      ['94025', 'Menlo Park', 'CA', '06085', 37.4529, -122.1817, 12000, 0.2],
      
      // Boston MA: 02116 (Back Bay), 02110 (Financial District)
      ['02116', 'Boston', 'MA', '25025', 42.3504, -71.0765, 29000, 0.6],
      ['02110', 'Boston', 'MA', '25025', 42.3570, -71.0550, 22000, 0.4],
      
      // Chicago IL: 60603 (The Loop), 60654 (River North)
      ['60603', 'Chicago', 'IL', '17031', 41.8800, -87.6300, 25000, 0.4],
      ['60654', 'Chicago', 'IL', '17031', 41.8900, -87.6500, 27000, 0.4],
      
      // Los Angeles CA: 90067 (Century City), 90210 (Beverly Hills)
      ['90067', 'Los Angeles', 'CA', '06037', 34.0539, -118.4000, 22000, 0.7],
      ['90210', 'Beverly Hills', 'CA', '06037', 34.0736, -118.4004, 21000, 0.5],
      
      // Austin TX: 78701 (Downtown), 78758 (The Domain)
      ['78701', 'Austin', 'TX', '48453', 30.2672, -97.7431, 32000, 0.8],
      ['78758', 'Austin', 'TX', '48453', 30.3600, -97.7200, 35000, 0.9],
      
      // Seattle WA: 98101 (Downtown), 98109 (South Lake Union)
      ['98101', 'Seattle', 'WA', '53033', 47.6062, -122.3321, 34000, 0.6],
      ['98109', 'Seattle', 'WA', '53033', 47.6200, -122.3500, 31000, 0.5],
      
      // Miami FL: 33131 (Brickell), 33130 (Downtown Miami), 33134 (Coral Gables)
      ['33131', 'Miami', 'FL', '12086', 25.7617, -80.1918, 28000, 0.5],
      ['33130', 'Miami', 'FL', '12086', 25.7500, -80.2000, 24000, 0.5],
      ['33134', 'Miami', 'FL', '12086', 25.7300, -80.2200, 20000, 0.5],
      
      // Washington DC: 20005 (Downtown), 20007 (Georgetown)
      ['20005', 'Washington', 'DC', '11001', 38.9000, -77.0200, 29000, 0.5],
      ['20007', 'Washington', 'DC', '11001', 38.9000, -77.0500, 27000, 0.4],
      
      // Dallas TX: 75201 (Uptown), 75202 (Downtown)
      ['75201', 'Dallas', 'TX', '48113', 32.7767, -96.7970, 34000, 0.5],
      ['75202', 'Dallas', 'TX', '48113', 32.7700, -96.8000, 28000, 0.4],
      
      // Atlanta GA: 30305 (Buckhead)
      ['30305', 'Atlanta', 'GA', '13121', 33.8400, -84.3800, 28000, 0.5],
      
      // Greenwich CT: 06830 (Downtown Greenwich)
      ['06830', 'Greenwich', 'CT', '09001', 41.0262, -73.6280, 12000, 0.4],
      
      // Mountain View CA: 94040 (Downtown Mountain View)
      ['94040', 'Mountain View', 'CA', '06085', 37.3861, -122.0839, 6543, 0.3],
      
      // San Jose CA: 95113 (Downtown San Jose)
      ['95113', 'San Jose', 'CA', '06085', 37.3382, -121.8863, 26000, 0.6],
    ];
  ...
  private *generateMetroAreas(): Generator<MetroArea> {
    const metroData: Array<[string, string, number, string, string]> = [
      // Metro areas for exact 16 locations
      ...
      ['San Jose-Sunnyvale-Santa Clara, CA', '41940', 2021426, 'Mountain View', 'CA'],
